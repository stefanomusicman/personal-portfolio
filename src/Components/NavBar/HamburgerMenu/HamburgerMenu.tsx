...
const HamburgerMenu = () => {
  ...
  return (
    <Menu right>
      ...
      <a className="menu-item" href="https://drive.google.com/file/d/1KvxPDevFPi-9VvTMwOtIqv40LMk4wp_3/view?usp=sharing" target='_blank' rel="noopener noreferrer">Resumé</a>
    </Menu>
  );
};
